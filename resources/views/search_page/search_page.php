				...
				<!-- Nav -->
					<nav id="nav">
						<ul>
							...
							<li><a href="#one">Qué hay detrás?</a></li>
		...
		<!-- Intro -->
			<section id="intro" class="main style1 dark fullscreen">
				<div class="content container 75%">
					<header>
						<h2>Que comience la búsqueda</h2>
					</header>

					<div>
						<input class="seacrh_text" type="text" placeholder="Ingrese una palabra a buscar">

						<a href="#" onclick="toggle_visibility('foo');">
							<img class="icon_search" src="images/search_page/search.png" title="config" alt="" />
							
						</a>
						<a href="#" onclick="toggle_visibility('foo');">
							
							<img class="icon_search" src="images/search_page/config.png" title="config" alt="" />
						</a>
					</div>
